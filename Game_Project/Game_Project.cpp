...
void GameSetup()
{
	...
	// ayy lmao
	testMsh = myEngine->LoadMesh("BlackholeQuad.x");
	testMdl = testMsh->CreateModel(0, 0, 80);
	testMdl->SetSkin("Blackhole.png");
	testMdl->Scale(3);
	...
	float pos1[2][MAX_WAYPOINTS] = { {-8, -8, -8,  -8,  -8, -10, -40, -65, -88, -88, -88, -88, -78, -60, -40, -20,   0,  40,  80, 300, 340, 380, 428, 412, 412, 412, 412, 412, 412, 412, 412,  412,  412,  412,  412,  412,  412,  412,  412,  412,  412,  412,  412,  412,  412,   -8,    -8,   -8,   -8,   -8,   -8,  -8,  -8, },
	...
	float pos3[2][MAX_WAYPOINTS] = { { 8,  8,  8,   8,   8, -10, -40, -65, -72, -72, -72, -72, -62, -60, -40, -20,   0,  40,  80, 300, 340, 380, 412, 428, 428, 428, 428, 428, 428, 428, 428,  428,  428,  428,  428,  428,  428,  428,  428,  428,  428,  428,  428,  428,  428,    8,    8,    8,    8,    8,    8,   8,   8, },
